...
class PicturePreviewScreen extends StatefulWidget {
  const PicturePreviewScreen({Key? key, required this.selectedImage})
      : super(key: key);
...
class _PicturePreviewScreenState extends State<PicturePreviewScreen> {
  ...
  Widget build(BuildContext context) {
    final imagePreviewController = Get.put(ImagePreviewController());
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            CircleAvatar(
              child: IconButton(icon: const Icon(Icons.save),onPressed: ()=>imagePreviewController.onTakeScreenShotAndSave(context),),
